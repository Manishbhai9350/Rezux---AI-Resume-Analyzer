...
const upload = () => {
  ...
  async function onSubmit(e: FormEvent) {
    ...
    const feedback =
      typeof analysisResult.message.content === "string"
    ...
    const uploadedData = await kv.set(`resume:${uuid}`, JSON.stringify(data));
      ...
      <section className="main-section w-full min-h-screen h-fit relative z-20">
        {isProcessing ? (
          ...
          <>
            ...
            <form
              onSubmit={onSubmit}
              className="upload-form flex flex-col justify-start items-center px-4"
            >
